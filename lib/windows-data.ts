...
export const governmentWindows: GovernmentWindow[] = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        name: "ID Card",
        nameAm: "የመለያ ካርድ",
        nameOr: "Kaardii Agarsiisa",
      },
      {
        id: 3,
        name: "Marriage Certificate",
        nameAm: "የጋብቻ ወረቀት",
        nameOr: "Ragaa Fuudhii",
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        nameAm: "የኖር ማረጋገጫ ደብዳቤ",
        nameOr: "Xalayaa Teessoo",
      },
      {
        id: 5,
    ...
    services: [
      {
        ...
        nameAm: "የኢንቨስትመንት ፍቃድ",
        nameOr: "Hayyama Ijaarsa",
      },
    ],
  },
  {
