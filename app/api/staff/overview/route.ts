...
// GET - Fetch staff dashboard overview statistics (requires dashboard:staff permission)
export async function GET(request: NextRequest) {
  try {
    // Check permission
    const { response, userId } = await requirePermission(request, "dashboard:staff");
