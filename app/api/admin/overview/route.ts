...
// GET - Fetch admin dashboard overview statistics (requires dashboard:admin permission)
export async function GET(request: NextRequest) {
  try {
    // Check permission
    const { response, userId } = await requirePermission(request, "dashboard:admin");
