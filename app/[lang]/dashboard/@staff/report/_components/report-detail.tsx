...
export function ReportDetail({
  ...
  const { fetchReportById } = useStaffReportStore();
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader>
            ...
            <DialogDescription>
              {t("dashboard.viewDetailedReportInformation") ||
          ...
          >
            ...
            >
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">
                    {t("dashboard.reportInformation") || "Report Information"}
                  </CardTitle>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">
                    {t("dashboard.senderInformation") || "Sender Information"}
                  </CardTitle>
                </CardHeader>
                  ...
                  {report.reportSentByUser ? (
                    <>
                      ...
                      <div className="flex items-center gap-2">
                        <User className="w-4 h-4 text-muted-foreground" />
                        <span className="text-sm">
                          <strong>{t("dashboard.phone") || "Phone"}:</strong>{" "}
                    ...
                    <p className="text-sm text-muted-foreground">
                      {t("dashboard.noSenderInformation") ||
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">
                    {t("dashboard.receiverInformation") ||
                ...
                <CardContent className="space-y-3">
                  {report.reportSentToUser ? (
                    ...
                    <p className="text-sm text-muted-foreground">
                      {t("dashboard.noReceiverInformation") ||
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">
                    {t("dashboard.dateInformation") || "Date Information"}
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">
                      <strong>{t("dashboard.created") || "Created"}:</strong>{" "}
                      {format(
        ...
        <Dialog open={fileViewerOpen} onOpenChange={setFileViewerOpen}>
          <DialogContent className="!w-screen !h-screen !max-w-none !max-h-none !m-0 !p-0 !rounded-none !top-0 !left-0 !translate-x-0 !translate-y-0 !sm:max-w-none">
            ...
            <DialogTitle className="sr-only">
              {selectedFile.name} -{" "}
              {t("dashboard.filePreview") || "File Preview"}
            </DialogTitle>
